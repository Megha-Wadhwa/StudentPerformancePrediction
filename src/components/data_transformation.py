...
class DataTransformation:
        ...
        try:
            ...
            num_pipeline= Pipeline(
                steps=[
                    ...
                    ("scaler", StandardScaler() ) #Perform standardScaler
                ]
            )

            cat_pipeline=Pipeline(
                steps=[
                    ("imputer",SimpleImputer(strategy="most_frequent")), #handling missing value mode operation
    ...
    def initiate_data_transformation(self,train_path, test_path):
        ...
        try:
            ...
            logging.info("Entering into Data Transformation component")
